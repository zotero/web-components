<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="444" height="441" viewBox="0 0 444 441">
  <defs>
    ...
    <g id="chrome">
      ...
      <rect id="url" x="66" y="97" width="137" height="6" fill="#ddd"/>
      ...
      <g id="connector">
        ...
        <path id="journal-icon" d="M345.707,93H338v14h12V97.293Zm2.586,4H346V94.707Zm.707,9H339V94h6v4h4Zm-6-8h-2V97h2Zm4,3h-6v-1h6Zm0,3h-6v-1h6Z" fill="#0069e0"/>
  ...
  <g style="isolation: isolate">
    ...
    <use id="zotero-front" xlink:href="#zotero"/>

    <g id="magnifier">
      <g clip-path="url(#clip-path)">
        <rect x="244" width="200" height="200" fill="#fff"/>
        <rect x="7" y="80" width="396" height="40" fill="#f6f6f6"/>
        <rect x="401" y="80" width="2" height="108" fill="#e6e6e6"/>
        <path d="M7,40H394a9,9,0,0,1,9,9V80a0,0,0,0,1,0,0H7a0,0,0,0,1,0,0V40A0,0,0,0,1,7,40Z" fill="#e6e6e6"/>
        <g>
          <circle cx="379.5" cy="94.5" r="1.5" fill="#ddd"/>
          <circle cx="379.5" cy="100.5" r="1.5" fill="#ddd"/>
          <circle cx="379.5" cy="106.5" r="1.5" fill="#ddd"/>
        </g>
        <rect id="connector-button-lg" x="330" y="86" width="28" height="28" rx="4.5" ry="4.5" fill="none"/>
    ...
    <g id="cursor">
      <g>
        <g>
          <polygon points="15.455 16.035 0 0.543 0 21.897 4.299 17.721 7.306 24.842 12.113 22.796 9.312 16.035 15.455 16.035" fill="#fff"/>
          <polygon points="12.22 14.663 1.333 3.752 1.333 18.67 4.717 15.404 7.876 22.92 10.335 21.888 7.295 14.663 12.22 14.663" fill="#777"/>
        </g>
        <rect width="15.455" height="24.842" fill="none"/>
      </g>
    </g>
  </g>
</svg>
