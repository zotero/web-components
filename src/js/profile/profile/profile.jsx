...
export default class Profile extends React.Component {
	...
	componentWillMount() {
		...
		profileEventSystem.addListener('alert', this.onAlert);
	}
	...
	render() {
		var activityTab, networkTab, groupsTab, alert;
		...
		if(this.state.extended) {
			activityTab = <Tab title="Activity" active={this.state.active == 'Activity'} onMakeActive={ () => this.makeActive('Activity') }>
							Activity
						</Tab>;
