...
let immediateCharge = function(expiration=0){
...
let calculateRemainingValue = function(expiration=Date.now(), storageLevel=2) {
	//log.debug(expiration);
...
let calculateNewExpiration = function(oldExpiration, oldStorageLevel, newStorageLevel) {
