...
//with callback specified during registration
//const consumerKey = 'c78bd174f4e46178e09c';
//const consumerSecret = '8bc5c2aaac7895045172';
...
let handshake = async function(){
	...
	*/
	...
	try{
		...
		let redirectUrl = `${zotero_authorize_endpoint}?oauth_token=${requestToken['key']}`;
